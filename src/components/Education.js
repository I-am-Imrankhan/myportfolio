      ...
      <div class="educations">
        ...
        <div class="education">
          <div class="resume-content">
            ...
            <p>Javascript, React, Angular, HTML, CSS, Bootstrap
              UI , UX och Graphical design

              Node.js, npm,Express, JSON, json-server, MongoDB, .net
        ...
        <div class="education">
          <div class="resume-content">
            ...
            <p>Android, Java, xCode, Swift, , JavaScript, HTML, CSS, Bootstrap
              UI , UX och graphic design

              Firebse, Firestore, Realtime database(Firebase), SQL, SQLLite, Ionic app development.
        ...
        <div class="education">
          <div class="resume-content">
            ...
            <div className="subjects">
              <p>● Mathematics A, B.</p>
              <p>● Abstract Algebra I, II, Real Analysis.</p>
              <p>● Topology I, II</p>
              <p>● Topology I, II. Complex Analysis I, II Economics, Statistics</p>
              <p>● Introduction programming, introduction to C++</p>
              <p>● Functional analysis I, II. Partial differential equation. Number theory.</p>
              <p>● Physics I, II</p>
            </div>
          </div>
          <div class="resume-date text-md-right">
